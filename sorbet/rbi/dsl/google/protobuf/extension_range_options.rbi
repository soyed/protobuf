...
class Google::Protobuf::ExtensionRangeOptions
  ...
  def initialize(declaration: Google::Protobuf::RepeatedField.new(:message, Google::Protobuf::ExtensionRangeOptions::Declaration), uninterpreted_option: Google::Protobuf::RepeatedField.new(:message, Google::Protobuf::UninterpretedOption), verification: nil); end
